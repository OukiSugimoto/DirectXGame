...
#pragma endregion
#pragma region 2_1の内容
	//平行移動
	//std::string translationDebag =
	...
	//debugText_->Print(translationDebag, 50, 50, 1.0f);

	////回転角
	//std::string rotationDebag = std::string("rotationtion:(") +
	...
	//debugText_->Print(rotationDebag, 50, 70, 1.0f);

	////スケール
	//std::string scaleDebag = std::string("scale:(") + 
 //   std::to_string(worldTransform_.scale_.x) +std::string(",") + 
	...
	//debugText_->Print(scaleDebag, 50, 90, 1.0f);
#pragma endregion
#pragma region 2_2の内容
	//視点移動距離
	{
		////視点の移動ベクトル
		//XMFLOAT3 move = {0, 0, 0};
